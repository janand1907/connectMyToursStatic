...
const tour = keralaTours.find((t) => t.slug === "temple-nature-trail");

export const metadata = pageMetadata("/kerala/temple-nature-trail");

const breadcrumbItems = [
  { label: "Home", href: "/" },
  { label: "Kerala", href: "/kerala" },
  { label: tour.title, href: "/kerala/temple-nature-trail" },
];

export default function KeralaTempleNatureTrailPage() {
  return (
    <ServiceDetailLayout
